...
# ======================================================================================
# B1-EXT-GH 05 v02 — HEAVY NATIONAL GRAPHHOPPER IMPORT
#
...
# First-attempt memory contract for the actual 15.7 GiB Windows machine.
# We deliberately use a smaller heap with MMAP and ParallelGC, following GraphHopper's
# documented low-memory import guidance. There is NO automatic retry with a larger heap.
HEAP_XMS_MIB = 512
HEAP_XMX_GIB = 6
MIN_AVAILABLE_PHYSICAL_GIB = 7.5
MIN_AVAILABLE_COMMIT_GIB = 10.0
...
def main() -> int:
    ...
    print("=" * 126)
    print("B1-EXT-GH 05 v02 — HEAVY NATIONAL GRAPHHOPPER IMPORT")
    print("=" * 126)
    ...
    print(f"Heap             = -Xms{HEAP_XMS_MIB}m -Xmx{HEAP_XMX_GIB}g -XX:+UseParallelGC")
    print(f"Required RAM available >= {MIN_AVAILABLE_PHYSICAL_GIB:.1f} GiB")
    print(f"Required commit avail  >= {MIN_AVAILABLE_COMMIT_GIB:.1f} GiB")
    ...
    if mem["avail_pagefile_gib"] is None:
        print("COMMIT_GATE = NOT_READY (cannot read available commit)")
        print("HEAVY_IMPORT = NOT_STARTED")
        print("PROJECT_WRITES = NONE")
        print("=== RUN COMPLETATA ===")
        return 3

    if mem["avail_pagefile_gib"] < MIN_AVAILABLE_COMMIT_GIB:
        print("COMMIT_GATE = NOT_READY")
        print("ACTION = verify Windows virtual memory/pagefile before import")
        print("HEAVY_IMPORT = NOT_STARTED")
        print("PROJECT_WRITES = NONE")
        print("=== RUN COMPLETATA ===")
        return 3
    ...
    pre = {
        ...
        "hardware_preflight": {
            **mem,
            ...
            "min_available_commit_gib": MIN_AVAILABLE_COMMIT_GIB,
    ...
    try:
        ...
        print(f"IMPORT_HEAP = -Xms{HEAP_XMS_MIB}m -Xmx{HEAP_XMX_GIB}g -XX:+UseParallelGC")
